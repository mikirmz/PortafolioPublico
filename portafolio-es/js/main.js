...
$('document').ready(function()
{
  ...
  //Boton de correo que abre el cliente de correo
  $('#boton-correo').click(function(){
    window.open('mailto:ejemplo@gmail.com');
  });
  //Boton para ir arriba de la pantalla
  $('#boton-arriba').click(function(){
    $('body, html').animate({
      scrollTop: '0px'
    }, 300);
  });
  //Aparece el boton para ir arrbia y calcula el scroll para ejecutar animación de habilidades
